    ...
    <div className="p-4 w-full max-w-[300px] min-w-[250px] box-border bg-white text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-200">
      ...
      <div className="rounded-lg shadow p-3 mb-3 relative bg-white dark:bg-gray-800 transition-colors duration-200">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-base font-semibold m-0 text-gray-700 dark:text-gray-200">
            提示统计
          </h2>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-2">
            <div className="w-4 h-4 rounded-full border-2 border-gray-200 border-t-blue-500 animate-spin dark:border-gray-700 dark:border-t-blue-400"></div>
            <span className="ml-2 text-gray-500 text-sm dark:text-gray-400">
              加载中...
            </span>
          </div>
        ) : error ? (
          <div className="text-red-500 text-center text-sm dark:text-red-400">
            {error}
          </div>
        ) : (
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm mt-1 mb-0 dark:text-gray-400">
              个可用提示
            </p>
          </div>
        )}
